...
```{r project_pipeline, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, layout="l-body-outset", fig.align='center', fig.width=6}
...
motion_lab_projects |> 
  ...
  mutate(fill_color = viridis::turbo(4)[x_coord],
         fill_color = colorspace::lighten(fill_color, 0.5)) |> 
...
```{r fig_projects_polar, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, autodep=TRUE, fig.align='center', out.width='90%'}
knitr::include_graphics(path = "discussion_topics/p_projects_polar.svg")
```
