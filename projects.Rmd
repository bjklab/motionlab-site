...
### REBEL: Quantifying respiratory and gut bacterial strain persistence to predict pneumonia treatment failure (R01 AI202932)  
Hospital-acquired pneumonia (HAP) and ventilator-associated pneumonia (VAP) are bacterial infections of the respiratory tract that occur during hospitalization. HAP and VAP are hard to treat: even when the bacterium causing HAP or VAP is recognized, antibiotic treatment for HAP and VAP often fails, resulting in a prolonged hospital stay, critical illness, or even death. We are studying human subjects with HAP or VAP to improve how we quantify the respiratory bacterial response to antibiotics, so that we can better understand how antibiotic failure occurs, better tailor antibiotic duration to optimize treatment response, and achieve HAP and VAP cures.  
