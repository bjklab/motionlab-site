...
```{r members, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, layout="l-body-outset", fig.width=6}
...
motion_people |> 
  ...
  select(headshot_path, biography, role, your_last_name) |> 
...
motion_bios |> 
  ...
  gtExtras::gt_img_rows(columns = headshot_path, img_source = "local", height = 200) |> 
...
```{r partners, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, layout="l-body-outset", fig.width=6}
