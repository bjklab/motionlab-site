...
```{r upcoming_meetings, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, layout="l-body-outset", fig.width=6}
...
motion_lab_schedule |> 
  ...
  gtExtras::gt_highlight_rows(rows = Focus == "E-MOTION Joint Meeting", fill = "grey24", font_color = "white", target_col = "Focus", font_weight = "normal")
#   gt_color_rows(
#     Focus, 
...
```{r past_meetings, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, layout="l-body-outset", fig.width=6}
